...
/**
 * InitiatePaymentResponse Class Doc Comment
 *
 * @category Class
 * @package  Tatrapayplus\TatrapayplusApiClient
 * @author   OpenAPI Generator team
 ...
 */
class InitiatePaymentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setTatraPayPlusUrl($tatra_pay_plus_url)
    {
        if (is_null($tatra_pay_plus_url)) {
            throw new \InvalidArgumentException('non-nullable tatra_pay_plus_url cannot be null');
        }
