...
class AvailablePaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets payment_method
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\PaymentMethod
     */
     ...
     * Sets payment_method
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\PaymentMethod $payment_method payment_method
     *
     * @return self
     */
    ...
    public function setReasonCodeMethodAvailability($reason_code_method_availability)
    {
        if (is_null($reason_code_method_availability)) {
            throw new \InvalidArgumentException('non-nullable reason_code_method_availability cannot be null');
        }
        $allowedValues = $this->getReasonCodeMethodAvailabilityAllowableValues();
        if (!in_array($reason_code_method_availability, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'reason_code_method_availability', must be one of '%s'",
                    $reason_code_method_availability,
                    implode("', '", $allowedValues)
                )
            );
        }
    ...
    public function setReasonCodeMethodAvailabilityDescription($reason_code_method_availability_description)
    {
        if (is_null($reason_code_method_availability_description)) {
            throw new \InvalidArgumentException('non-nullable reason_code_method_availability_description cannot be null');
        }
