...
/**
 * SignedCardIdObj Class Doc Comment
 *
 * @category Class
 * @package  Tatrapayplus\TatrapayplusApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SignedCardIdObj implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSignedCardId($signed_card_id)
    {
        ...
        if ((mb_strlen($signed_card_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $signed_card_id when calling SignedCardIdObj., must be smaller than or equal to 1024.');
        }
