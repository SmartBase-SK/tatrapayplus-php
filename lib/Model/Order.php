    ...
    */
    ...
    public function setOrderNo($order_no)
    {
        ...
        if ((mb_strlen($order_no) > 100)) {
            throw new \InvalidArgumentException('invalid length for $order_no when calling Order., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($order_no) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_no when calling Order., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderItems($order_items)
    {
        ...
        if ((count($order_items) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $order_items when calling Order., number of items must be less than or equal to 1000.');
        }
        if ((count($order_items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_items when calling Order., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPreferredLoanDuration($preferred_loan_duration)
    {
        if (is_null($preferred_loan_duration)) {
            throw new \InvalidArgumentException('non-nullable preferred_loan_duration cannot be null');
        }
