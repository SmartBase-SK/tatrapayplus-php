...
/**
 * PaymentIntentCancelResponse Class Doc Comment
 *
 * @category Class
 * @description **TatraPayPlus cancel response. **
 * @package  Tatrapayplus\TatrapayplusApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentIntentCancelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
