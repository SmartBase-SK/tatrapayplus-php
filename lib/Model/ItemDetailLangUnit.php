...
/**
 * ItemDetailLangUnit Class Doc Comment
 *
 * @category Class
 * @package  Tatrapayplus\TatrapayplusApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ItemDetailLangUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setItemName($item_name)
    {
        ...
        if ((mb_strlen($item_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $item_name when calling ItemDetailLangUnit., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($item_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $item_name when calling ItemDetailLangUnit., must be bigger than or equal to 1.');
        }
    ...
    public function setItemDescription($item_description)
    {
        ...
        if ((mb_strlen($item_description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $item_description when calling ItemDetailLangUnit., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($item_description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $item_description when calling ItemDetailLangUnit., must be bigger than or equal to 1.');
        }
