...
/**
 * InitiateDirectTransactionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class InitiateDirectTransactionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets amount
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\Amount
     */
     ...
     * Sets amount
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\Amount $amount amount
     *
     * @return self
     */
     ...
     * Gets end_to_end
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\E2e
     */
     ...
     * Sets end_to_end
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\E2e $end_to_end end_to_end
     *
     * @return self
     */
    public function setEndToEnd($end_to_end)
    {
        if (is_null($end_to_end)) {
            throw new \InvalidArgumentException('non-nullable end_to_end cannot be null');
        }
     ...
     * Gets tds_data
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\DirectTransactionTDSData
     */
     ...
     * Sets tds_data
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\DirectTransactionTDSData $tds_data tds_data
     *
     * @return self
     */
    ...
    {
        if (is_null($tds_data)) {
            throw new \InvalidArgumentException('non-nullable tds_data cannot be null');
        }
     ...
     * Gets token
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\Token
     */
     ...
     * Sets token
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\Token $token token
     *
     * @return self
     */
