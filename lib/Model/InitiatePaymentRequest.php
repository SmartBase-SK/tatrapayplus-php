...
/**
 * InitiatePaymentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class InitiatePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets base_payment
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\BasePayment
     */
     ...
     * Sets base_payment
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\BasePayment $base_payment base_payment
     *
     * @return self
     */
    public function setBasePayment($base_payment)
    {
        if (is_null($base_payment)) {
            throw new \InvalidArgumentException('non-nullable base_payment cannot be null');
        }
     ...
     * Gets user_data
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\UserData|null
     */
     ...
     * Sets user_data
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\UserData|null $user_data user_data
     *
     * @return self
     */
     ...
     * Gets bank_transfer
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\BankTransfer|null
     */
     ...
     * Sets bank_transfer
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\BankTransfer|null $bank_transfer bank_transfer
     *
     * @return self
     */
     ...
     * Gets card_detail
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\CardDetail|null
     */
     ...
     * Sets card_detail
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\CardDetail|null $card_detail card_detail
     *
     * @return self
     */
    public function setCardDetail($card_detail)
    {
        if (is_null($card_detail)) {
            throw new \InvalidArgumentException('non-nullable card_detail cannot be null');
        }
     ...
     * Gets pay_later
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\PayLater|null
     */
     ...
     * Sets pay_later
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\PayLater|null $pay_later pay_later
     *
     * @return self
     */
    public function setPayLater($pay_later)
    {
        if (is_null($pay_later)) {
            throw new \InvalidArgumentException('non-nullable pay_later cannot be null');
        }
