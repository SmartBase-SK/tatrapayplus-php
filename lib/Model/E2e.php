 ...
 */
class E2e implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setVariableSymbol($variable_symbol)
    {
        ...
        if ((!preg_match("/^[0-9]{1,10}$/", ObjectSerializer::toString($variable_symbol)))) {
            throw new \InvalidArgumentException("invalid value for \$variable_symbol when calling E2e., must conform to the pattern /^[0-9]{1,10}$/.");
        }
    ...
    public function setSpecificSymbol($specific_symbol)
    {
        ...
        if ((!preg_match("/^[0-9]{1,10}$/", ObjectSerializer::toString($specific_symbol)))) {
            throw new \InvalidArgumentException("invalid value for \$specific_symbol when calling E2e., must conform to the pattern /^[0-9]{1,10}$/.");
        }
    ...
    public function setConstantSymbol($constant_symbol)
    {
        ...
        if ((!preg_match("/^[0-9]{1,4}$/", ObjectSerializer::toString($constant_symbol)))) {
            throw new \InvalidArgumentException("invalid value for \$constant_symbol when calling E2e., must conform to the pattern /^[0-9]{1,4}$/.");
        }
