    ...
    */
    ...
    public function setRemittanceInformationUnstructured($remittance_information_unstructured)
    {
        ...
        if ((mb_strlen($remittance_information_unstructured) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remittance_information_unstructured when calling BankTransfer., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[ 0-9a-zA-Z?:()\/\\.,'+-]{1,100}$/", ObjectSerializer::toString($remittance_information_unstructured)))) {
            throw new \InvalidArgumentException("invalid value for \$remittance_information_unstructured when calling BankTransfer., must conform to the pattern /^[ 0-9a-zA-Z?:()\/\\.,'+-]{1,100}$/.");
        }
