...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets item_detail
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\ItemDetail
     */
     ...
     * Sets item_detail
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\ItemDetail $item_detail item_detail
     *
     * @return self
     */
    public function setItemDetail($item_detail)
    {
        if (is_null($item_detail)) {
            throw new \InvalidArgumentException('non-nullable item_detail cannot be null');
        }
    ...
    public function setItemInfoUrl($item_info_url)
    {
        if (is_null($item_info_url)) {
            throw new \InvalidArgumentException('non-nullable item_info_url cannot be null');
        }
    ...
    public function setItemImage($item_image)
    {
        if (is_null($item_image)) {
            throw new \InvalidArgumentException('non-nullable item_image cannot be null');
        }
        if ((mb_strlen($item_image) > 1000000)) {
            throw new \InvalidArgumentException('invalid length for $item_image when calling OrderItem., must be smaller than or equal to 1000000.');
        }
