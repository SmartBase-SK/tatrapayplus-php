...
class ItemDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets item_detail_sk
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\ItemDetailLangUnit
     */
     ...
     * Sets item_detail_sk
     *
     * @param \Tatrapayplus\TatrapayplusApiClient\Model\ItemDetailLangUnit $item_detail_sk item_detail_sk
     *
     * @return self
     */
    public function setItemDetailSk($item_detail_sk)
    {
        if (is_null($item_detail_sk)) {
            throw new \InvalidArgumentException('non-nullable item_detail_sk cannot be null');
        }
     ...
     * Gets item_detail_en
     *
     * @return \Tatrapayplus\TatrapayplusApiClient\Model\ItemDetailLangUnit|null
     */
    ...
    public function setItemDetailEn($item_detail_en)
    {
        if (is_null($item_detail_en)) {
            throw new \InvalidArgumentException('non-nullable item_detail_en cannot be null');
        }
