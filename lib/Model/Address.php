    ...
    */
    ...
    public function setStreetName($street_name)
    {
        ...
        if ((mb_strlen($street_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling Address., must be smaller than or equal to 40.');
        }
    ...
    public function setBuildingNumber($building_number)
    {
        ...
        if ((mb_strlen($building_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $building_number when calling Address., must be smaller than or equal to 10.');
        }
    ...
    public function setTownName($town_name)
    {
        ...
        if ((mb_strlen($town_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $town_name when calling Address., must be smaller than or equal to 35.');
        }
    ...
    public function setPostCode($post_code)
    {
        ...
        if ((mb_strlen($post_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $post_code when calling Address., must be smaller than or equal to 10.');
        }
